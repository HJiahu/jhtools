...
static const char* tfGetExt (tfFILE* file)
{
...
static void tfTraverse (const char* path, tfCallback cb, void* udata)
{
    tfDIR dir;
    tfDirOpen (&dir, path);
...
static int tfReadFile (tfDIR* dir, tfFILE* file)
{
...
static void tfDirNext (tfDIR* dir)
{
...
static void tfDirClose (tfDIR* dir)
{
    dir->path[0] = 0;
    dir->has_next = 0;
...
static int tfDirOpen (tfDIR* dir, const char* path)
{
